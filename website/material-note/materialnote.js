  ...
  var renderer = {
    ...
    var dropdown = renderer.create('<div class="dropdown-content">', function ($node, options) {
        ...
        var markup = $.isArray(options.items) ? options.items.map(function (item) {
            ...
            return '<li><a href="javascript:;" ' + (dataValue + dataOption) + '>' + content + '</a></li>';
        }).join('') : options.items;
    ...
    var dropdownCheck = renderer.create('<div class="dropdown-content note-check">', function ($node, options) {
        var markup = $.isArray(options.items) ? options.items.map(function (item) {
            var value = (typeof item === 'string') ? item : (item.value || '');
            var content = options.template ? options.template(item) : item;
            return '<li><a href="javascript:;" data-value="' + value + '">' + icon(options.checkClassName) + ' ' + content + '</a></li>';
        }).join('') : options.items;
        $node.html(markup);
    });
  ...
  var Placeholder = function (context) {
    ...
    var LinkDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var footer = [
                '<a href="javascript:;" class="modal-action modal-close waves-effect waves-light btn ">' + lang.shortcut.close + '</a>',
                '<button href="javascript:;" class="btn note-link-btn disabled" disabled>' + lang.link.insert + '</button>'
            ].join('');
    ...
    var ImageDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var footer = [
                '<a href="javascript:;" class="modal-action modal-close waves-effect waves-light btn ">' + lang.shortcut.close + '</a>',
                '<button href="javascript:;" class="btn note-image-btn disabled" disabled>' + lang.image.insert + '</button>'
            ].join('');
    ...
    */
    ...
    var VideoDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var footer = [
                '<a href="javascript:;" class="modal-action modal-close waves-effect waves-light btn ">' + lang.shortcut.close + '</a>',
                '<button href="javascript:;" class="btn note-video-btn disabled" disabled>' + lang.video.insert + '</button>'
            ].join('');
  ...
  var HintPopover = function (context) {
    ...
    var CardDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var footer = [
                '<a href="javascript:;" class="modal-action modal-close waves-effect waves-light btn ">' + lang.shortcut.close + '</a>',
                '<button href="javascript:;" class="btn note-materialize-card-btn">' + lang.materializeComponents.card.insert + '</button>'
            ].join('');
